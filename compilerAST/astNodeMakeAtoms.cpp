...
static astNode *makeAtomsCB ( astNode *node, astNode *parent, symbolStack *sym, bool isAccess, class errorHandler *err, bool isLS )
{
...
void astNode::makeAtoms ( symbolStack *sym, class errorHandler *err, bool isLS )
{
	try {
		astNodeWalk ( this, sym, makeAtomsCB, err, isLS );
	} catch ( errorNum e )
	{
...
static astNode *makeAtomsCodeBlockCB ( astNode *node, astNode *parent, symbolStack *sym, bool isAccess, class errorHandler *err )
{
	errorLocality e ( err, node );
