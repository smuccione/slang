...
using symbolSource = std::variant<std::monostate, class opFunction *, class opClassElement *, class symbolParamDef *, class symbol *, class opSymbol *, class opClass *, class astNode *, symbolTypeClass>;
