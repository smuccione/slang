...
HTML_TAG htmlTags[] =	{
							{ "ABBR",			HTML_SPECIAL::HTML_S_NONE,		"HTMLABBRELEMENT",			1, 0, 0, 1 },
							{ "ACRONYM",		HTML_SPECIAL::HTML_S_NONE,		"HTMLACRONYMELEMENT",		1, 0, 0, 1 },
							{ "ADDRESS",		HTML_SPECIAL::HTML_S_NONE,		"HTMLADDRESSELEMENT",		1, 0, 0, 1 },
							{ "APPLET",			HTML_SPECIAL::HTML_S_APPLETS,		"HTMLAPPLETELEMENT",		1, 0, "APPLETS", 1 },				// needs special
							{ "AREA",			HTML_SPECIAL::HTML_S_NONE,		"HTMLARRAYELEMENT",			0, 0, 0, 1 },
							{ "A",				HTML_SPECIAL::HTML_S_ANCHORS,		"HTMLANCHORELEMENT",		1, NAME_ATTR, "ANCHORS", 0 },
							{ "BASEFONT",		HTML_SPECIAL::HTML_S_NONE,		"HTMLBASEFONE",				0, 0, 0, 1 },
							{ "BASE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLBASEELEMENT",			0, 0, 0, 1 },
							{ "BDO",			HTML_SPECIAL::HTML_S_NONE,		"HTMLBDODLEMENT",			1, 0, 0, 1 },
							{ "BIG",			HTML_SPECIAL::HTML_S_NONE,		"HTMLBIGELEMENT",			1, 0, 0, 1 },
							{ "BLOCKQUOTE",		HTML_SPECIAL::HTML_S_NONE,		"HTMLQUOTEELEMENT",			1, 0, 0, 1 },
							{ "BODY",			HTML_SPECIAL::HTML_S_NONE,		"HTMLBODYELEMENT",			1, 0, 0, 0 },
							{ "BR",				HTML_SPECIAL::HTML_S_NONE,		"HTMLBRELEMENT",			0, 0, 0, 1 },
							{ "BUTTON",			HTML_SPECIAL::HTML_S_NONE,		"HTMLBUTTONELEMENT",		1, 0, 0, 1 },
							{ "B",				HTML_SPECIAL::HTML_S_NONE,		"HTMLBELEMENT",				1, 0, 0, 1 },
							{ "CAPTION",		HTML_SPECIAL::HTML_S_TCAPTION,	"HTMLTABLECAPTIONELEMENT",	1, 0, 0, 0 },
							{ "CENTER",			HTML_SPECIAL::HTML_S_NONE,		"HTMLCENTERELEMENT",		1, 0, 0, 1 },
							{ "CITE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLCITEELEMENT",			1, 0, 0, 1 },
							{ "CODE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLCODEELEMENT",			1, 0, 0, 1 },
							{ "COL",			HTML_SPECIAL::HTML_S_NONE,		"HTMLTABLECOLELEMENT",		0, 0, 0, 1 },
							{ "COLGROUP",		HTML_SPECIAL::HTML_S_NONE,		"HTMLTABLECOLELEMENT",		1, 0, 0, 1 },
							{ "DD",				HTML_SPECIAL::HTML_S_NONE,		"HTMLDDELEMENT",			1, 0, 0, 1 },
							{ "DEL",			HTML_SPECIAL::HTML_S_NONE,		"HTMLDELELEMENT",			1, 0, 0, 1 },
							{ "DFN",			HTML_SPECIAL::HTML_S_NONE,		"HTMLDFNELEMENT",			1, 0, 0, 1 },
							{ "DIR",			HTML_SPECIAL::HTML_S_NONE,		"HTMLDIRELEMENT",			1, 0, 0, 1 },
							{ "DIV",			HTML_SPECIAL::HTML_S_NONE,		"HTMLDIVELEMENT",			1, 0, 0, 1 },
							{ "DL",				HTML_SPECIAL::HTML_S_NONE,		"HTMLDLISTELEMENT",			1, 0, 0, 1},
							{ "DT",				HTML_SPECIAL::HTML_S_NONE,		"HTMLDTELEMENT",			1, 0, 0, 1 },
							{ "EM",				HTML_SPECIAL::HTML_S_NONE,		"HTMLEMELEMENT",			1, 0, 0, 1 },
							{ "FIELDSET",		HTML_SPECIAL::HTML_S_NONE,		"HTMLFIELDSETELEMENT",		1, 0, 0, 0 },
							{ "FONT",			HTML_SPECIAL::HTML_S_NONE,		"HTMLFONTELEMENT",			1, 0, 0, 1 },
							{ "FORM",			HTML_SPECIAL::HTML_S_FORMS,		"HTMLFORMELEMENT",			1, 0, "FORMS", 0 },
							{ "FRAMESET",		HTML_SPECIAL::HTML_S_NONE,		"HTMLFRAMESETELEMENT",		1, 0, 0, 1 },
							{ "FRAME",			HTML_SPECIAL::HTML_S_NONE,		"HTMLFRAMEELEMENT",			0, 0, 0, 1 },
							{ "H1",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADINGELEMENT",		1, 0, 0, 1 },
							{ "H2",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADINGELEMENT",		1, 0, 0, 1 },
							{ "H3",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADINGELEMENT",		1, 0, 0, 1 },
							{ "H4",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADINGELEMENT",		1, 0, 0, 1 },
							{ "H5",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADINGELEMENT",		1, 0, 0, 1 },
							{ "H6",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADINGELEMENT",		1, 0, 0, 1 },
							{ "HEAD",			HTML_SPECIAL::HTML_S_NONE,		"HTMLHEADELEMENT",			1, 0, 0, 0 },
							{ "HR",				HTML_SPECIAL::HTML_S_NONE,		"HTMLHRELEMENT",			0, 0, 0, 1 },
							{ "HTML",			HTML_SPECIAL::HTML_S_NONE,		"HTMLHTMLELEMENT",			1, 0, 0, 0 },
							{ "IFRAME",			HTML_SPECIAL::HTML_S_NONE,		"HTMLLIFRAMEELEMENT",		0, 0, 0, 1 },
							{ "IMG",			HTML_SPECIAL::HTML_S_IMAGES,		"HTMLIMAGEELEMENT",			0, 0, "IMAGES", 0 },
							{ "INPUT",			HTML_SPECIAL::HTML_S_INPUT,		"HTMLINPUTELEMENT",			0, 0, 0, 0 },
							{ "INS",			HTML_SPECIAL::HTML_S_NONE,		"HTMLINSELEMENT",			1, 0, 0, 1 },
							{ "ISINDEX",		HTML_SPECIAL::HTML_S_NONE,		"HTMLISINDEXELEMENT",		0, 0, 0, 0 },
							{ "I",				HTML_SPECIAL::HTML_S_NONE,		"HTMLIELEMENT",				1, 0, 0, 1 },
							{ "KBD",			HTML_SPECIAL::HTML_S_NONE,		"HTMLKBDELEMENT",			1, 0, 0, 0 },
							{ "LABEL",			HTML_SPECIAL::HTML_S_NONE,		"HTMLLABELELEMENT",			1, 0, 0, 1 },
							{ "LEGEND",			HTML_SPECIAL::HTML_S_NONE,		"HTMLLEGENEELEMENT",		1, 0, 0, 1 },
							{ "LINK",			HTML_SPECIAL::HTML_S_LINKS,		"HTMLLINKELEMENT",			0, 0, "LINKS", 0 },
							{ "LI",				HTML_SPECIAL::HTML_S_NONE,		"HTMLLIELEMENT",			1, 0, 0, 1 },
							{ "MAP",			HTML_SPECIAL::HTML_S_NONE,		"HTMLMAPELEMENT",			1, 0, 0, 1 },
							{ "MENU",			HTML_SPECIAL::HTML_S_NONE,		"HTMLMENUELEMENT",			1, 0, 0, 1 },
							{ "META",			HTML_SPECIAL::HTML_S_NONE,		"HTMLMETAELEMENT",			0, META_ATTR, 0, 1 },
							{ "NOFRAMES",		HTML_SPECIAL::HTML_S_NONE,		"HTMLNOFRAMESELEMENT",		1, 0, 0, 1 },
							{ "NOSCRIPT",		HTML_SPECIAL::HTML_S_NONE,		"HTMLNOSCRIPTELEMENT",		1, 0, 0, 1 },
							{ "OBJECT",			HTML_SPECIAL::HTML_S_NONE,		"HTMLOBJECTELEMENT",		1, 0, 0, 0 },
							{ "OL",				HTML_SPECIAL::HTML_S_NONE,		"HTMLOLISTELEMENT",			1, 0, 0, 0 },
							{ "OPTGROUP",		HTML_SPECIAL::HTML_S_NONE,		"HTMLOPTGROUPELEMENT",		1, 0, 0, 0 },
							{ "OPTION",			HTML_SPECIAL::HTML_S_OPTION,		"HTMLOPTIONELEMENT",		1, 0, 0, 0 },
							{ "PARAM",			HTML_SPECIAL::HTML_S_NONE,		"HTMLPARAMELEMENT",			0, 0, 0, 1 },
							{ "PRE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLPREELEMENT",			1, 0, 0, 1 },
							{ "P",				HTML_SPECIAL::HTML_S_NONE,		"HTMLPARAGRAPHELEMENT",		1, 0, 0, 1 },
							{ "Q",				HTML_SPECIAL::HTML_S_NONE,		"HTMLQELEMENT",				1, 0, 0, 1 },
							{ "SAMP",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSAMPELEMENT",			1, 0, 0, 1 },
							{ "SCRIPT",			HTML_SPECIAL::HTML_S_SCRIPT,		"HTMLSCRIPTELEMENT",		1, 0, 0, 0 },
							{ "SELECT",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSELECTELEMENT",		1, 0, 0, 0 },
							{ "SMALL",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSMALLELEMENT",			1, 0, 0, 1 },
							{ "SPAN",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSPANELEMENT",			1, 0, 0, 1 },
							{ "STRIKE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSTRIKEELEMENT",		1, 0, 0, 1 },
							{ "STRONG",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSTRONGELEMENT",		1, 0, 0, 1 },
							{ "STYLE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSTYLEELEMENT",			1, 0, 0, 1 },
							{ "SUB",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSUBELEMENT",			1, 0, 0, 1 },
							{ "SUP",			HTML_SPECIAL::HTML_S_NONE,		"HTMLSUPELEMENT",			1, 0, 0, 1 },
							{ "S",				HTML_SPECIAL::HTML_S_NONE,		"HTMLSELEMENT",				1, 0, 0, 1 },
							{ "TABLE",			HTML_SPECIAL::HTML_S_TABLE,		"HTMLTABLEELEMENT",			1, 0, 0, 1 },
							{ "TBODY",			HTML_SPECIAL::HTML_S_TBODY,		"HTMLTABLESECTIONELEMENT",	1, 0, 0, 1 },
							{ "TD",				HTML_SPECIAL::HTML_S_CELL,		"HTMLTABLECELLELEMENT",		1, TD_ATTR, 0, 1 },
							{ "TEXTAREA",		HTML_SPECIAL::HTML_S_NONE,		"HTMLTEXTARRAYELEMENT",		1, 0, 0, 1 },
							{ "TFOOT",			HTML_SPECIAL::HTML_S_TFOOT,		"HTMLTABLESECTIONELEMENT",	1, 0, 0, 1 },
							{ "THEAD",			HTML_SPECIAL::HTML_S_THEAD,		"HTMLTABLESECTIONELEMENT",	1, 0, 0, 1 },
							{ "TH",				HTML_SPECIAL::HTML_S_CELL,		"HTMLTABLECELLELEMENT",		1, 0, 0, 1 },
							{ "TITLE",			HTML_SPECIAL::HTML_S_NONE,		"HTMLTITLEELEMENT",			1, 0, 0, 1 },
							{ "TR",				HTML_SPECIAL::HTML_S_TROW,		"HTMLTABLEROWELEMENT",		1, 0, 0, 1 },
							{ "TT",				HTML_SPECIAL::HTML_S_NONE,		"HTMLTTELEMENT",			1, 0, 0, 1 },
							{ "UL",				HTML_SPECIAL::HTML_S_NONE,		"HTMLULISTELEMENT",			1, 0, 0, 1 },
							{ "U",				HTML_SPECIAL::HTML_S_NONE,		"HTMLUELEMENT",				1, 0, 0, 1 },
							{ "VAR",			HTML_SPECIAL::HTML_S_NONE,		"HTMLVARELEMENT",			1, 0, 0, 1 },
							{ "!--",			HTML_SPECIAL::HTML_S_NONE,		0,							0, 0, 0, 0 },	// dummy... for tag match but handled seprately
							{ 0,				HTML_SPECIAL::HTML_S_NONE,		0,							0, 0, 0, 0 },	// last one
						};
