...
static astNode *getValueCB ( astNode *node, astNode *parent, symbolStack *sym, bool isAccess )
{
	switch ( node->getOp ( ) )
	{
		case astOp::symbolValue:
...
static astNode*constantFoldBlockCB (astNode* node, astNode* parent, symbolStack* sym, bool isAccess )
{
