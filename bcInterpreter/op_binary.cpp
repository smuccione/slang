		...
		case slangType::eSTRING:
			switch ( TYPE ( rightOperand ) )
			{
				case slangType::eLONG:
					...
					(instance->stack - 1)->dat.l = memcmp ( tmpString, leftOperand->dat.str.c, leftOperand->dat.str.len + 1 ) ? 0 : 1;
					break;
				case slangType::eDOUBLE:
					int sign;
					int dec;
					...
					break;
				case slangType::eSTRING:
					(instance->stack - 1)->dat.l = memcmp ( rightOperand->dat.str.c, leftOperand->dat.str.c, leftOperand->dat.str.len + 1 ) ? 0 : 1;
					break;
				default:
					(instance->stack - 1)->dat.l = 0;
					break;
	...
	switch ( TYPE ( leftOperand ) )
	{
		...
		case slangType::eSTRING:
			switch ( TYPE ( rightOperand ) )
			{
				case slangType::eLONG:
					_i64toa_s ( leftOperand->dat.l, tmpString, sizeof ( tmpString ), 10 );
					(instance->stack - 2)->dat.l = memcmp ( tmpString, leftOperand->dat.str.c, leftOperand->dat.str.len + 1 ) ? 0 : 1;
					break;
				case slangType::eDOUBLE:
					int sign;
					int dec;
					...
					break;
				case slangType::eSTRING:
					(instance->stack - 2)->dat.l = memcmp ( rightOperand->dat.str.c, leftOperand->dat.str.c, leftOperand->dat.str.len + 1 ) ? 0 : 1;
					break;
				default:
					(instance->stack - 2)->dat.l = 0;
					break;
	...
	switch ( TYPE ( leftOperand ) )
	{
		...
		case slangType::eSTRING:
			...
			switch ( TYPE ( rightOperand ) )
			{
				...
				case slangType::eLONG:
					_i64toa_s ( leftOperand->dat.l, tmpString, sizeof ( tmpString ), 10 );
					(instance->stack - 2)->dat.l = memcmp ( tmpString, leftOperand->dat.str.c, leftOperand->dat.str.len + 1 ) ? 1 : 0;
					break;
				case slangType::eDOUBLE:
					int sign;
					int dec;
					...
					break;
				case slangType::eSTRING:
					(instance->stack - 2)->dat.l = memcmp ( rightOperand->dat.str.c, leftOperand->dat.str.c, leftOperand->dat.str.len + 1 ) ? 1 : 0;
					break;
				default:
					(instance->stack - 2)->dat.l = 1;
					break;
	...
	switch ( TYPE ( leftOperand ) )
	{
		...
		case slangType::eSTRING:
			...
			switch ( TYPE ( rightOperand ) )
			{
				...
				case slangType::eLONG:
					_i64toa_s ( leftOperand->dat.l, tmpString, sizeof ( tmpString ), 10 );
					(instance->stack - 2)->dat.l = memcmp ( leftOperand->dat.str.c, tmpString, leftOperand->dat.str.len + 1 ) < 0;
					break;
				case slangType::eDOUBLE:
					int sign;
					int dec;
					...
					break;
				case slangType::eSTRING:
					(instance->stack - 2)->dat.l = memcmp ( leftOperand->dat.str.c, rightOperand->dat.str.c, leftOperand->dat.str.len + 1 ) < 0;
					break;
				default:
					(instance->stack - 2)->dat.l = 1;
					break;
