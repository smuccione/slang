...
bool srcLocation::operator < ( srcLocation const &right ) const noexcept
{
	...
	{
		if ( lineNumberStart < right.lineNumberStart ) return true;
		if ( lineNumberStart == right.lineNumberStart && columnNumber < right.columnNumber ) return true;
