...
extern			int		 _convHexExtended   ( unsigned char *src, unsigned char *dst );
extern			int		 _convHexExtended_s ( unsigned char *src, int srcLen, unsigned char *dst, int dstLen );
