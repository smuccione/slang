...
struct VAR {
	...
	VAR ( int64_t const value )
	{
		type = slangType::eLONG;
		dat.l = value;
	}

	VAR ( uint64_t const value )
	{
		type = slangType::eLONG;
		dat.l = (int64_t)value;
	}
...
#pragma warning(suppress: 26495)
	VAR ( int32_t const value )
	{
		type = slangType::eLONG;
		dat.l = value;
	}

	VAR ( uint32_t const value )
	{
		type = slangType::eLONG;
		dat.l = value;
	}
#pragma warning(suppress: 26495)
	VAR ( int16_t const value )
	{
		type = slangType::eLONG;
		dat.l = value;
	}

	VAR ( uint16_t const value )
	{
		type = slangType::eLONG;
		dat.l = value;
	}

	VAR ( int8_t const value )
	{
		type = slangType::eLONG;
		dat.l = (uint64_t)(int)value;
	}

	VAR ( uint8_t const value )
	{
		type = slangType::eLONG;
		dat.l = value;
	}

	VAR ( double const value )
	{
		type = slangType::eLONG;
		dat.d = value;
	}

	VAR ( float const value )
	{
		type = slangType::eLONG;
		dat.d = value;
	}
