...
static void csvReaderNew ( vmInstance *instance, VAR_OBJ *obj, char const *fileName, bool columnHeaders )
{
	...
	if (!memcmp ( reader->fileContents, "\xEF\xBB\xBF", 3 ))
	{
...
static VAR_OBJ_TYPE<_P("csvReaderEnumerator")>  csvReaderGetEnumerator ( vmInstance *instance, VAR_OBJ *obj )
{
...
static VAR_OBJ_TYPE<_P("csvReaderEnumerator")> csvReaderEnumeratorGetEnumerator ( vmInstance *instance, VAR_OBJ *obj )
{
	return *obj;
}

static VAR_OBJ_TYPE<_P("csvLine")> csvReaderEnumeratorCurrent ( vmInstance *instance, VAR_OBJ *obj )
{
