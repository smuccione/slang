...
static void assert_eq ( class vmInstance *instance, VAR *val1, VAR *val2 )
{
	...
	switch ( TYPE( val1 ) )
	{
		...
		case slangType::eSTRING:
			...
			if ( memcmp( val1->dat.str.c, val2->dat.str.c, val1->dat.str.len ) != 0 ) throw errorNum::scASSERT;
			break;
		default:
	...
	if ( TYPE( val1 ) == TYPE( val2 ) )
	{
		switch ( TYPE( val1 ) )
		{
			...
			case slangType::eSTRING:
				...
				{
					if ( !memcmp( val1->dat.str.c, val2->dat.str.c, val1->dat.str.len ) ) throw errorNum::scASSERT;
				}
				break;
			default:
				throw errorNum::scASSERT;
		...
		case slangType::eSTRING:
			{
				...
				if ( memcmp( val1->dat.str.c, val2->dat.str.c, len ) > 0 ) throw errorNum::scASSERT;
			}
			break;
		default:
			throw errorNum::scASSERT;
