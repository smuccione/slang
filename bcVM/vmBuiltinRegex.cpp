...
static VAR_OBJ_TYPE<_P("regexEnumerator")> regexEnumeratorGetEnumerator ( vmInstance *instance, VAR_OBJ *obj )
{
	return *obj;
}
...
#if 0
static VAR_OBJ_TYPE<_P("regexEnumerator")>  regexMatch ( vmInstance *instance, VAR_OBJ *obj, VAR_STR *str, int64_t flags )
{
