...
static void cContainerGcCb ( class vmInstance *instance, VAR_OBJ *val, objectMemory::collectionVariables *col )
{
	...
	if ( col->doCopy ( oldTable ) )
	{
		...
		instance->om->move ( instance, nullptr, &oldTable->comp.cbFunc, false, col );
...
static VAR_OBJ_TYPE<_P( MAKE_NAME ( CONTAINER_NAME ) "Enumerator")>  cContainerFind ( vmInstance *instance, VAR_OBJ *object, VAR *index )
{
	PUSH ( *object );
...
static VAR_OBJ_TYPE<_P( MAKE_NAME ( CONTAINER_NAME ) "Enumerator")> cContainerGetEnumerator ( vmInstance *instance, VAR_OBJ *object )
{
	PUSH ( *object );
...
static VAR_OBJ_TYPE<_P( MAKE_NAME ( CONTAINER_NAME ) "Enumerator")> containerEnumeratorGetEnumerator ( vmInstance *instance, VAR_OBJ *object )
{
	return *object;
}
