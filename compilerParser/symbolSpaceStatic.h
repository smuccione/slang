...
public:
	symbolStatic ( opFile *file, cacheString const &qualPrefix, cacheString const &name, symbolTypeClass const &type, srcLocation const &location, stringi const &documentation, class astNode *initializer = 0 );
	symbolStatic ( opFile *file, cacheString const &qualPrefix, class astNode *initializer, symbolTypeClass const &type, stringi const &documentation );
