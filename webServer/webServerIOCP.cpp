...
{
public:
	void debugContinue ( vmDebugMessage *instance ) override
	{
	}

	void debugInterrupt ( vmDebugMessage *msg ) override
	{
	}
};
...
//			printf ( "%08p     socket: %4d   state: %19s    nBytes: %9d\r\n", sock, (uint32_t)sock->socket, iocpStateNames[sock->state], nBytesTransferred );
