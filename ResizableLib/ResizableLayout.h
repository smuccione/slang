...
// fix for #pragma supress issue in latest VS compiler
template<>
AFX_INLINE UINT AFXAPI HashKey ( HWND key )
{
...
#pragma warning(suppress: 4311) // pointer truncation
	ldiv_t HashVal = ldiv ( (long)(HWND)(key), 127773 );
...
protected:
	...
	public:
		...
		LayoutInfo(HWND hwnd, SIZE tl_t, SIZE tl_m, 
			...
			sizeTypeBR(br_t), sizeMarginBR(br_m), bMsgSupport ( FALSE )
		{ }
	};
